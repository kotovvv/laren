(self["webpackChunklara"] = self["webpackChunklara"] || []).push([["resources_js_components_crmanager_lids_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    filterGStatus: function filterGStatus(newval, oldval) {
      if (newval == 0) {
  ...
  computed: {
    group: function group() {
      ...
      return lodash__WEBPACK_IMPORTED_MODULE_1___default().filter(this.users, function (o) {
    ...
    filteredItems: function filteredItems() {
      ...
      return this.lids.filter(function (i) {
        return (!_this.filterStatus || i.status_id == _this.filterStatus) && (!_this.filterProviders || i.provider_id == _this.filterProviders) && (!_this.filtertel || reg.test(i.tel)) && (!_this.showDuplicates || _this.telsDuplicates.includes(i.id)) && (!_this.filterOffices || _this.filterOffices.includes(i.office_id));
      });
    }
  },
  methods: {
    getOffices: function getOffices() {
      ...
      if (self.$props.user.role_id == 1 && self.$props.user.office_id == 0) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/getOffices").then(function (res) {
    ...
    getDuplicates: function getDuplicates() {
      this.telsDuplicates = this.lids.filter(this.duplicatesOnly).map(function (f) {
        return f.id;
      });
    },
    duplicatesOnly: function duplicatesOnly(v1, i1, self) {
      var ndx = self.findIndex(function (v2, i2) {
    ...
    searchInDB: function searchInDB() {
      var self = this;
      var send = {};
      send.group_id = self.$props.user.group_id;
      send.role_id = self.$props.user.role_id;
      send.search = self.searchAll;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("api/Lid/searchlids", send).then(function (res) {
        // console.log(res.data);
        self.lids = Object.entries(res.data).map(function (e) {
          return e[1];
        });
        self.lids.map(function (e) {
          e.user = self.users.find(function (u) {
            return u.id == e.user_id;
          }).fio;
          e.date_created = e.created_at.substring(0, 10);

          if (self.providers.find(function (p) {
            return p.id == e.provider_id;
          })) {
            e.provider = self.providers.find(function (p) {
              return p.id == e.provider_id;
            }).name;
          }

          if (e.status_id) e.status = self.statuses.find(function (s) {
            return s.id == e.status_id;
          }).name;
        });
        self.disableuser = 0;
      })["catch"](function (error) {
    ...
    deleteItem: function deleteItem() {
      ...
      this.filteredItems.forEach(function (el) {
        ids.push(el.id);
        self.lids.splice(self.lids.indexOf(self.lids.find(function (l) {
          return l.id == el.id;
        })), 1);
      });
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("api/Lid/deletelids", ids).then(function (response) {
        self.getUsers(); // self.getLids(send.user_id);
    ...
    changeLidsUser: function changeLidsUser() {
      var self = this;
      var cur_user_id = this.disableuser;
      var send = {};
      ...
      if (self.$props.user.role_id == 2) {
        ...
        send.data = send.data.filter(function (f) {
          return f.status_id != 9;
        });
      }

      axios__WEBPACK_IMPORTED_MODULE_0___default().post("api/Lid/changelidsuser", send).then(function (response) {
        self.search = "";
        self.filtertel = "";
        self.userid = null;
    ...
    usercolor: function usercolor(user) {
    ...
    clickrow: function clickrow(value) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/StasusesOfId/" + value.id).then(function (res) {
    ...
    getUsers: function getUsers() {
      var self = this;
      var get = self.$props.user.role_id == 1 ? "/api/users" : "/api/getusers";
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(get).then(function (res) {
        self.users = res.data.map(function (_ref) {
          var name = _ref.name,
              id = _ref.id,
        ...
        if (self.$props.user.role_id != 1) {
          self.users = self.users.filter(function (f) {
            return f.group_id == self.$props.user.group_id;
          });
        }
      })["catch"](function (error) {
        return console.log(error);
    ...
    getStatuses: function getStatuses() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/statuses").then(function (res) {
        self.statuses = res.data.map(function (_ref2) {
    ...
    getStatusLids: function getStatusLids(id) {
      var self = this;
      self.filterStatus = 0;
      self.search = "";
      self.filtertel = "";
      ...
      send.role_id = self.$props.user.role_id;
      send.id = id;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/statuslids", send).then(function (res) {
        // console.log(res.data);
        self.lids = Object.entries(res.data).map(function (e) {
          return e[1];
        });
        self.lids.map(function (e) {
          if (self.users.find(function (u) {
            return u.id == e.user_id;
          })) {
            e.user = self.users.find(function (u) {
              return u.id == e.user_id;
          ...
          if (self.statuses.find(function (s) {
            return s.id == e.status_id;
          })) e.status = self.statuses.find(function (s) {
            return s.id == e.status_id;
          }).name;
        });
        self.searchAll = ""; // if (localStorage.filterStatus1) {
    ...
    getLids: function getLids(id) {
      var self = this;
      self.filterStatus = 0;
      self.search = "";
      self.filtertel = "";
      self.disableuser = id;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/userlids/" + id).then(function (res) {
        // console.log(res.data);
        self.lids = Object.entries(res.data).map(function (e) {
          return e[1];
        });
        ...
        self.searchAll = ""; // if (localStorage.filterStatus) {
    ...
    changeStatus: function changeStatus() {
      ...
      if (this.selected.length && this.selectedStatus) {
        ...
        send.data = this.selected.map(function (e) {
          return e;
        });
        this.changeLids(send);
      }
    },
    changeLids: function changeLids(send) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("api/Lid/updatelids", send).then(function (response) {
        self.afterUpdateLids();
      })["catch"](function (error) {
        console.log(error);
      });
    },
    afterUpdateLids: function afterUpdateLids() {
      var self = this;
      self.selected = []; // self.selectedStatus = 0;
    ...
    getProviders: function getProviders() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/provider").then(function (res) {
        self.providers = res.data.map(function (_ref3) {
          var name = _ref3.name,
              id = _ref3.id;
          return {
            name: name,
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VCheckbox/VCheckbox.sass":
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VCheckbox/VCheckbox.sass ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VExpansionPanel/VExpansionPanel.sass":
/*!************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VExpansionPanel/VExpansionPanel.sass ***!
  \************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadio.sass":
/*!***********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadio.sass ***!
  \***********************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadioGroup.sass":
/*!****************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadioGroup.sass ***!
  \****************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/styles/components/_selection-controls.sass":
/*!*******************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/styles/components/_selection-controls.sass ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.blk_statuses[data-v-3ba40a68] {\n  display: flex;\n  grid-gap: 10px;\n}\n.blk_statuses .status_wrp[data-v-3ba40a68] {\n  display: inline-flex;\n}\n.v-card__text.scroll-y[data-v-3ba40a68] {\n  overflow-y: auto;\n  height: 60vh;\n}\n.tel[data-v-3ba40a68]:hover {\n  cursor: url(/img/phone-forward.svg) 10 10, none;\n  text-decoration: none;\n}\n.tel[data-v-3ba40a68] {\n  display: block;\n  color: #000;\n}\n#maintable.v-data-table[data-v-3ba40a68] tr {\n  outline: 2px solid transparent;\n}\n#maintable.v-data-table[data-v-3ba40a68] tr:hover,\n#maintable.v-data-table[data-v-3ba40a68] tr.v-data-table__selected {\n  /* border: 2px solid #000; */\n  cursor: pointer;\n}\n#maintable.v-data-table[data-v-3ba40a68] tr.v-data-table__selected {\n  border-bottom: transparent !important;\n}\n#maintable.v-data-table[data-v-3ba40a68] tr.v-data-table__expanded tr:hover {\n  border: none;\n}\n#maintable[data-v-3ba40a68] .text-start {\n  padding: 0 !important;\n}\n.blackborder[data-v-3ba40a68] {\n  /* border: 2px solid #000; */\n  border-top: transparent !important;\n}\n.wrp__statuses[data-v-3ba40a68] {\n  display: grid;\n  grid-template-columns: repeat(4, auto);\n}\n.wrp__statuses label[data-v-3ba40a68] {\n  border: 3px solid transparent;\n}\n.wrp__statuses input:checked + label[data-v-3ba40a68] {\n  border: 3px solid #7620df;\n  border-radius: 30px;\n}\n.status_wrp span[data-v-3ba40a68] {\n  padding: 5px;\n  white-space: nowrap;\n  overflow: hidden;\n  max-width: 85px;\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VCheckbox_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!../../../../postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!../../../../sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./VCheckbox.sass */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VCheckbox/VCheckbox.sass");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VCheckbox_sass__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VCheckbox_sass__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VExpansionPanel_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!../../../../postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!../../../../sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./VExpansionPanel.sass */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VExpansionPanel/VExpansionPanel.sass");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VExpansionPanel_sass__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VExpansionPanel_sass__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadio_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!../../../../postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!../../../../sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./VRadio.sass */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadio.sass");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadio_sass__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadio_sass__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadioGroup_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!../../../../postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!../../../../sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./VRadioGroup.sass */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/components/VRadioGroup/VRadioGroup.sass");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadioGroup_sass__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_VRadioGroup_sass__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_selection_controls_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!../../../../postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!../../../../sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./_selection-controls.sass */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-15.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-15.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-15.use[3]!./node_modules/vuetify/src/styles/components/_selection-controls.sass");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_selection_controls_sass__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_15_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_15_use_2_sass_loader_dist_cjs_js_clonedRuleSet_15_use_3_selection_controls_sass__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_style_index_0_id_3ba40a68_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_style_index_0_id_3ba40a68_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/crmanager/lids.vue":
/*!****************************************************!*\
  !*** ./resources/js/components/crmanager/lids.vue ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lids.vue?vue&type=template&id=3ba40a68&scoped=true& */ "./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true&");
/* harmony import */ var _lids_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lids.vue?vue&type=script&lang=js& */ "./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js&");
/* harmony import */ var _lids_vue_vue_type_style_index_0_id_3ba40a68_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css& */ "./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _lids_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "3ba40a68",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/crmanager/lids.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js&":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./lids.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css&":
/*!*************************************************************************************************************!*\
  !*** ./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css& ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_style_index_0_id_3ba40a68_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=style&index=0&id=3ba40a68&scoped=true&lang=css&");


/***/ }),

/***/ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var vuetify_lib_components_VDataIterator__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vuetify/lib/components/VDataIterator */ "./node_modules/vuetify/lib/components/VDataIterator/VDataFooter.js");
...
/* harmony import */ var vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! vuetify/lib/components/VExpansionPanel */ "./node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanel.js");
/* harmony import */ var vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! vuetify/lib/components/VExpansionPanel */ "./node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanelContent.js");
/* harmony import */ var vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! vuetify/lib/components/VExpansionPanel */ "./node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanelHeader.js");
/* harmony import */ var vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! vuetify/lib/components/VExpansionPanel */ "./node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanels.js");
...
var render = function render() {
  ...
  return _c("div", [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_0__["default"], {
    attrs: {
      fluid: ""
    }
  }, [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_vm._v("\n        Фильтр по статусам\n        "), _c(vuetify_lib_components_VSelect__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attrs: {
      items: _vm.statuses,
      "item-text": "name",
      "item-value": "id",
  ...
  }), _vm._v(" "), _vm.filterStatus && _vm.$props.user.role_id == 1 && _vm.filteredItems.length > 0 ? _c(vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_4__["default"]) : _vm._e()], 1), _vm._v(" "), _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_vm._v("\n        Глобальный статус\n        "), _c(vuetify_lib_components_VSelect__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attrs: {
      items: _vm.statuses,
      "item-text": "name",
      "item-value": "id",
    ...
    model: {
      value: _vm.filterGStatus,
      callback: function callback($$v) {
        _vm.filterGStatus = $$v;
      },
      expression: "filterGStatus"
    }
  })], 1), _vm._v(" "), _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_vm._v("\n        Фильтр по поставщикам\n        "), _c(vuetify_lib_components_VSelect__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attrs: {
      items: _vm.providers,
      "item-text": "name",
      "item-value": "id",
    ...
    model: {
      value: _vm.filterProviders,
      callback: function callback($$v) {
        _vm.filterProviders = $$v;
      },
      expression: "filterProviders"
    }
  })], 1), _vm._v(" "), _vm.$props.user.role_id == 1 && _vm.$props.user.office_id == 0 ? _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_vm._v("\n        Фильтр office\n        "), _c(vuetify_lib_components_VSelect__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attrs: {
      items: _vm.offices,
      "item-text": "name",
      "item-value": "id",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref5) {
        var item = _ref5.item,
            index = _ref5.index;
        return [index === 0 ? _c(vuetify_lib_components_VChip__WEBPACK_IMPORTED_MODULE_5__["default"], [_c("span", [_vm._v(_vm._s(item.name))])]) : _vm._e(), _vm._v(" "), index === 1 ? _c("span", {
          staticClass: "grey--text text-caption"
        }, [_vm._v("\n              (+" + _vm._s(_vm.filterOffices.length - 1) + " )\n            ")]) : _vm._e()];
      }
    }], null, false, 3271391016),
    model: {
      value: _vm.filterOffices,
      callback: function callback($$v) {
        _vm.filterOffices = $$v;
      },
      expression: "filterOffices"
    }
  })], 1) : _vm._e(), _vm._v(" "), _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_vm._v("\n        Глобальный поиск\n        "), _c(vuetify_lib_components_VTextField__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    model: {
      value: _vm.filtertel,
      callback: function callback($$v) {
        _vm.filtertel = typeof $$v === "string" ? $$v.trim() : $$v;
      },
  ...
  }), _vm._v(" "), _vm.selectedStatus && _vm.selected.length ? _c(vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_4__["default"], {
    attrs: {
      color: "dark primary",
      "x-large": ""
    },
  ...
  }, [_vm._v("\n          Сменить статусы\n        ")]) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attrs: {
      cols: "9"
    }
  }, [_c("div", {
    staticClass: "border pa-4"
  }, [_c(vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ref: "datatable",
    attrs: {
      id: "tablids",
      headers: _vm.headers,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref8) {
        var pagination = _ref8.pagination,
            options = _ref8.options,
            updateOptions = _ref8.updateOptions;
        return [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], {
          attrs: {
            cols: "4"
          }
        }, [_c(vuetify_lib_components_VTextField__WEBPACK_IMPORTED_MODULE_6__["default"], {
          staticClass: "ml-3 border px-2",
          attrs: {
            "append-icon": "mdi-magnify",
            label: "Поиск",
            "single-line": "",
        ...
        }, [_c(vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_8__.VCardTitle, [_c(vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_9__["default"], {
          staticClass: "mt-0",
          on: {
            click: _vm.getDuplicates
          },
          scopedSlots: _vm._u([{
            key: "label",
            fn: function fn() {
              return [_c(vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_10__["default"], {
                attrs: {
                  small: ""
                }
              }, [_vm._v(" mdi-phone ")]), _vm._v(" "), _c(vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_10__["default"], {
                attrs: {
                  small: ""
                }
              }, [_vm._v(" mdi-phone ")])];
          ...
          model: {
            value: _vm.showDuplicates,
            callback: function callback($$v) {
              _vm.showDuplicates = $$v;
            },
            expression: "showDuplicates"
          }
        }, [_vm._v("\n                    >")])], 1)], 1), _vm._v(" "), _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], {
          attrs: {
            cols: "6"
          }
        }, [_c(vuetify_lib_components_VDataIterator__WEBPACK_IMPORTED_MODULE_11__["default"], {
          attrs: {
    ...
    staticClass: "mt-4 wrp_users",
    attrs: {
      cols: "3"
    }
  }, [_c("div", {
    staticClass: "row"
  }, [_c(vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_12__["default"], {
    staticClass: "rounded-xl pa-5 w-100",
    attrs: {
      rounded: ""
    }
  }, [_vm._v("\n          Укажите пользователя\n          "), _c("div", {
    staticClass: "scroll-y"
  }, [_c(vuetify_lib_components_VList__WEBPACK_IMPORTED_MODULE_13__["default"], [_c(vuetify_lib_components_VRadioGroup__WEBPACK_IMPORTED_MODULE_14__["default"], _vm._b({
    ref: "radiogroup",
    attrs: {
      id: "usersradiogroup"
    },
    on: {
      change: _vm.changeLidsUser
    },
    model: {
      value: _vm.userid,
      callback: function callback($$v) {
  ...
  }, "v-radio-group", _vm.users, false), [_c(vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_15__["default"], {
    ref: "akk",
    model: {
      value: _vm.akkvalue,
      callback: function callback($$v) {
    ...
    return _c(vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_16__["default"], {
      key: i
    }, [_c(vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_17__["default"], [item.pic ? _c("img", {
      staticClass: "v-expansion-panel-header__icon mr-1",
      attrs: {
        height: "60",
        width: "60",
        src: "/storage/" + item.pic
      }
    }) : _vm._e(), _vm._v("\n\n                      " + _vm._s(item.fio) + "\n                      "), _c("div")]), _vm._v(" "), _c(vuetify_lib_components_VExpansionPanel__WEBPACK_IMPORTED_MODULE_18__["default"], _vm._l(_vm.users.filter(function (i) {
      return i.group_id == item.group_id;
    }), function (user) {
      return _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], {
        key: user.id
      }, [_c(vuetify_lib_components_VRadioGroup__WEBPACK_IMPORTED_MODULE_19__["default"], {
        attrs: {
          label: user.fio,
          value: user.id,
      ...
      }, [_vm._v(_vm._s(user.hmlids))]), _vm._v(" "), user.statnew ? _c(vuetify_lib_components_VChip__WEBPACK_IMPORTED_MODULE_5__["default"], {
        attrs: {
          label: "",
          small: ""
        }
  ...
  }), 1)], 1)], 1)], 1)]), _vm._v(" "), _c(vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_12__["default"], {
    staticClass: "border pa-5 mt-1 w-100"
  }, [_c("div", {
    staticClass: "tel"
  }, [_vm._v("Тел: " + _vm._s(_vm.clickedItemTel))]), _vm._v(" "), _c("div", {
    staticClass: "mt-4"
  }, _vm._l(_vm.clickedItemStatuses, function (item, i) {
    return _c("div", {
      key: i,
      staticClass: "blk_statuses"
    }, [_c("span", {
      staticClass: "status_wrp"
    }, [_c("b", {
      style: {
        background: item.color,
        outline: "#999 solid 1px"
      }
    }), _vm._v(" "), _c("span", [_vm._v(_vm._s(item.name))])]), _c("span", [_vm._v(_vm._s(item.uname))]), _vm._v(" "), _c("span", [_vm._v(_vm._s(item.cdate))])]);
  }), 0)])], 1)])], 1)], 1);
};
...
/***/ "./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true& ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_4_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_4_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vuetify_loader_lib_loader_js_ruleSet_1_rules_0_use_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_4_node_modules_vue_loader_lib_index_js_vue_loader_options_lids_vue_vue_type_template_id_3ba40a68_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./lids.vue?vue&type=template&id=3ba40a68&scoped=true& */ "./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/crmanager/lids.vue?vue&type=template&id=3ba40a68&scoped=true&");
