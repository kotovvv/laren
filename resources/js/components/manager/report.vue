          ...
          <template v-slot:default>
            <thead>
              <tr>
                ...
                <th class="text-left">Number of sets</th>
                <th class="text-left">Total talk time</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      axios
        ...
        .then((res) => {
          ...
          let t = (res.data.callmonth[0].duration / 60 / 60)
            ...
            .toString()
            .split(".");
          self.monthReport.alltimecall = t[0] + " hour. " + t[1] + " min.";
          self.todayReport.hmcall = res.data.callday[0].count;
          t = (res.data.callday[0].duration / 60 / 60)
            .toFixed(2)
            .toString()
            .split(".");
          self.todayReport.alltimecall = t[0] + " hour. " + t[1] + " min.";
        })
        .catch(function (error) {
          console.log(error);
        });
